...
- [工业控制场景下滤波器算法研究](#工业控制场景下滤波器算法研究)
  ...
  - [11.中值滤波（Median Filter）](#11中值滤波median-filter)
    - [算法简介或算法定义](#算法简介或算法定义-3)
    - [算法的已知特点、优点、缺点以及适用场景](#算法的已知特点优点缺点以及适用场景)
      - [特点](#特点-4)
      - [优点](#优点-11)
      - [缺点](#缺点-11)
      - [适用场景](#适用场景-11)
  ...
  - [12.维纳滤波器](#12维纳滤波器)
    - [原理和方法描述](#原理和方法描述)
    - [算法的已知特点、优点、缺点以及适用场景](#算法的已知特点优点缺点以及适用场景-1)
      - [特点](#特点-5)
      - [优点](#优点-12)
      - [缺点](#缺点-12)
      - [适用场景](#适用场景-12)
    ...
    - [输出结果](#输出结果-12)
  - [13.卡尔曼滤波](#13卡尔曼滤波)
    - [算法简介或算法定义](#算法简介或算法定义-4)
    - [算法的已知特点、优点、缺点以及适用场景](#算法的已知特点优点缺点以及适用场景-2)
      - [特点](#特点-6)
      - [优点](#优点-13)
      - [缺点](#缺点-13)
      - [适用场景](#适用场景-13)
    ...
    - [代码](#代码-13)
    - [输出结果](#输出结果-13)
  - [14. 切比雪夫滤波器（Chebyshev Filter）](#14-切比雪夫滤波器chebyshev-filter)
    - [算法简介或算法定义](#算法简介或算法定义-5)
    - [算法的已知特点、优点、缺点以及适用场景](#算法的已知特点优点缺点以及适用场景-3)
      - [特点](#特点-7)
      - [优点](#优点-14)
      - [缺点](#缺点-14)
      - [适用场景](#适用场景-14)
    ...
    - [算法复杂度描述](#算法复杂度描述-9)
    - [输出结果](#输出结果-14)
  - [15.巴特沃兹滤波器（Butterworth Filter）](#15巴特沃兹滤波器butterworth-filter)
    - [算法简介或算法定义](#算法简介或算法定义-6)
    - [算法的已知特点、优点、缺点以及适用场景](#算法的已知特点优点缺点以及适用场景-4)
      - [特点](#特点-8)
      - [优点](#优点-15)
      - [缺点](#缺点-15)
      - [适用场景](#适用场景-15)
...
![数学模型](laplacian/laplacian_model.png)
...
[laplacian filter](laplacian/laplacian.py)

### 输出结果

![无数据预处理](laplacian/Comparision1.jpg)
![使用平滑滤波后](laplacian/Comparision2.jpg)
...
[算术平均滤波](average/average.py)

### 输出结果

![输出结果](average/Comparision.jpg)
...
![数学模型](airthmetic/airth_model.png)
...
[算术平均滤波](airthmetic/arithmetic.py)

### 输出结果

![初始数据——窗口大小为5，6——窗口大小为5+加权平均滤波](airthmetic/Comparision.jpg)

![局部放大图](airthmetic/airth_figure.png)
...
![不同滤波器阶数](IIR/IIR_figure.png)
![不同滤波器类型](IIR/Comparision.jpg)
...
![数学模型](gaussian/gaussian_model.png)
...
[gaussian_filter](gaussian/gaussian.py)

### 输出结果

![sigma为0.5，1.0，1.5](gaussian/Comparision.jpg)
![放大图](gaussian/gaussian_figure.png)
...
[切比雪夫滤波](Chebyshev/chebyshev_filter.py)
...
[巴特沃兹滤波](Butterworth/butterworth_filter.py)
